                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="text-center text-muted">
                                    Don't have account yet? <a href="{{route('user_register')}}">Sign up</a>
                                </div>
                                <form class="form-control" method="post" action="{{route('user_forgot_password')}}">
                                    @csrf
                                    <div class="mt-4">
                                ...
                                <div class="text-center text-muted mt-3 ">
                                    Forget it, <a href="{{route('user_login')}}">send me back</a> to the sign in screen.
                                </div>
                            </div>
                        </div>
                    </div>
