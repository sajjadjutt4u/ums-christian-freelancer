...
$(function(e){
  'use strict';
		...
		Highcharts.chart('hightchart1', {
			...
			xAxis: {
				gridLineColor: ' rgb(163, 67, 255,0.1)',
				allowDecimals: false,
				labels: {
					style: {
						color: '#Fff',
  ...
  'use strict';
	...
	Highcharts.chart('highchart3', {
		...
		series: [{
			...
			colors: ['rgb(0, 179, 255,0.7)  ', 'rgb(163, 67, 255,0.8)', '#f1c40f', '#24CBE5', '#64E572', '#FF9655', '#FFF263', '#6AF9C4']
		}]
	});
	...
	Highcharts.chart('highchart4', {
		...
		series: [{
			...
			colors: ['rgb(0, 179, 255,0.7)', 'rgb(163, 67, 255,0.8)', '#f1c40f']
		}]
	});
	...
	Highcharts.chart('highchart5', {
		...
		colors: ['#f1c40f', '#24CBE5', '#64E572' , 'rgb(0, 179, 255,0.7)  ', 'rgb(163, 67, 255,0.8)' ],
		credits: {
			enabled: false
		},
		series: [{
	...
	colors: ['rgb(0, 179, 255,0.7)  ', 'rgb(163, 67, 255,0.8)', '#f1c40f', '#24CBE5', '#64E572', '#FF9655', '#f1c40f', '#6AF9C4'],
    series: [{
        type: 'column',
        colorByPoint: true,
